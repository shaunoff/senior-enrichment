...
class StudentOverview extends Component {
    ...
    return <div>Loading......</div>
		...
		const student = this.props.students.filter(student => student.id === paramId)[0]
			...
			<div style={{ display: 'flex', height: 'calc(100vh - 130px)', borderRadius: '8px',backgroundColor: 'rgba(255,255,255,0.7)', marginRight: "10px"}}>
				<div style={styles.studentBlock}>
					...
					<div style={{height: "300px"}}>
					  ...
					  {this.state.text && <StudentMetaData assessment={this.handleAssessment} update={this.handleUpdate} student={student}/>}
					</div>
				</div>
